	...
	<div class="login-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="sub-main-w3 pt-md-4">
				<form action="s_insert.php" method="post" id="register_form">
					...
					<div class="form-style-agile form-group">
						...
						<label>Male</label>
						<input  class="form-control" name="Gender" type="radio" Value="Male" checked> 
						<label>Female</label>
						<input  class="form-control" name="Gender" type="radio" Value="Female">
