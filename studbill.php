...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Confirmation Slip</li>
		</ol>
	</nav>
	<!-- breadcrumb -->
	<!-- //banner -->
...
<br/><br/><br/>
	...
	<div class="contact py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Confirmation 
				<span class="font-weight-bold">Slip</span>
			</h3>
			...
			<!--<div class=
            "row contact-grids agile-1 py-sm-5 pb-sm-0 pb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p>Vallathol Nagar, Cheruthuruthy PO.
							<label>Thrissur Dt.,Pin: 679531.</label>
						</p>
					</div>
				</div>
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a href="mailto:info@example.com">varnakerala@gmail.com</a>
							<label>
								<a href="mailto:info@example.com">info_vk@hotmail.com</a>
							</label>
						</p>
					</div>
				</div>-->
