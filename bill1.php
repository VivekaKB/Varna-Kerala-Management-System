...
$i = 1;
$result = mysqli_query($con,"select * from studchild where bill_no='$_REQUEST[bill_no]'");

$row=mysqli_fetch_array($result);
$customer_id=$row['studm_id'];
...
<img src='images/REGISTARTON.PNG'width='900px'>
</td></tr>
...
<tr><th  width='160px' align='left'>Invoice No : </th><td width='160px' ><?php echo "REG_STUD-".$_REQUEST['bill_no'];?>  </td></tr>
...
<tr style='background:#ccc;' ><th style='font-weight:bold;text-align:center;' height='40px'> NO </th><th style='font-weight:bold;text-align:center;' colspan="3">PACKAGE NAME</th><th style='font-weight:bold;text-align:center;'>REGISTRATION FEE </th></tr>
...
TOTAL AMOUNT</th><th colspan="4"  style='text-align:right;font-size:16px;'> INR <?php echo $amt ?></th>
