...
<body>
	...
	<div class="login-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Password
				<span class="font-weight-bold">Reset</span>
			</h3>
			<!-- content -->
			<div class="sub-main-w3 pt-md-4">
				<form action="p_check.php" method="post">
					...
					<div class="form-style-agile form-group">
						...
						<input placeholder="Password" class="form-control" name="password" type="password" id="password1" >
					</div>
                    	<div class="form-style-agile form-group">
						<label>
							Confirm Password
						...
						<input placeholder="Password" class="form-control" name="password2" type="password" >
					</div>
