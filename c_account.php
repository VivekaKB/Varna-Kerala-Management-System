...
<!-- register -->
	...
	<div class="login-w3ls22 22py-5" style="background-image:url(images/bg7.jpg)">
		<div class="container py-xl-5 py-lg-3">
			...
			<!-- content -->
			<div class="sub-main-w322 pt-md-4">
				<form action="caccount_insert.php" method="post" id="register_form">
					<div class="form-style-agile form-group py-lg-3">
						<label><b>
							User ID</b>
							<i class="fas fa-user"></i>
					 ...
					 <div class="form-style-agile form-group py-lg-3">
						...
						<input class="form-control" type="text" name="account_no" id="password2" value=""  >
					</div>
                    ...
                    <div class="form-style-agile form-group py-lg-3">
						...
						<input class="form-control" type="password" name="password" id="password2"  value=""  >
					</div>
