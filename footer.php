			...
			<div class="row py-xl-5 py-sm-3">
				<div class="col-lg-6 map">
					...
					<div class="conta-posi-w3ls p-4 rounded">
						...
						<p>VarnaKerala Institute of Mural arts

							<span>Vallathol Nagar, Cheruthuruthy PO.,</span> Thrissur Dt.,Pin: 679531.</p>
					</div>
				</div>
				...
				<!--	<div class="subscribe-w3ls my-xl-5 my-4">
					...
					<p class="para-agileits-w3layouts text-white">
						<i class="fas fa-map-marker pr-3"></i>Vallathol Nagar, Cheruthuruthy PO.,Trissur</p>
					<p class="para-agileits-w3layouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i>+91-8111890857</p>
					<p class="para-agileits-w3layouts">
						<i class="far fa-envelope-open pr-2"></i>
						<a href="mailto:mail@example.com" class=" text-white">varnakerala@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
