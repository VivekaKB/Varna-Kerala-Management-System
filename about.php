...
<body>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row about-head-wthree">
				<div class="col-lg-6 left-abw3ls">
					<img src="images/side2.jpg" alt="" class="img-fluid">
				</div>
				<div class="col-lg-6 right-abw3ls mt-lg-0 mt-sm-5 mt-4">
					<h4 class="font-italic border-bottom text-center font-weight-bold pb-3 mb-4">Our Temple of Learning</h4>
					<p>History stands witness to the fact that great artists have outshined their contemporaries with their brilliant art, inspite of the lack of                       formal education to support their place in this world. Their brilliance in art has gifted the world some of the rarest of gems ever seen. Even                       today, in India we see that quite a few of such gifted artists lose sight of their future in the mundane intricacies of University and College                       rules. Their aspirations squashed before they have reached their destination. </p>
					<p class="mt-3">VarnaKerala is an institute on a mission to help such innumerable unrecognized artists; refine and sharpen their                                    skills to perfection. The institute seeks to provide extensive range of training in the least amount of time, with the use of the                                    most modern techniques and facilities. In the past 10 years, 500 of students have passed through these doors to excel in                                    varied streams of art and have made successful careers for themselves. The training at VarnaKerala not only provides you success as a                                     painter but also helps you establish your career in the fields of Fabric, Non-Fabric, Accecories and many more.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid py-xl-5 py-lg-3">
			<div class="row about-head-wthree-2">
				...
				<div class="col-lg-4 right-abw3ls my-lg-0 my-sm-5 my-4">
					...
					<p>VarnaKerala Institute of Mural Arts educates individuals to be professional artists and designers, pioneering thinkers, creative leaders, and engaged global citizens.
 </p><br><br>
                    <h4 class="font-italic border-bottom text-center font-weight-bold pb-3 mb-4">Our Vision</h4>
					<p class="mt-3">VarnaKerala Institute of Mural Arts transforms the world through creativity and purpose.</p>
				</div>
				<div class="col-lg-4 left-abw3ls text-lg-left text-center">
   ...
   <div class="about-page py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row about-head-wthree">
				<div class="col-lg-6 right-abw3ls">
					<img src="images/maxresdefault.jpg" alt="" class="img-fluid">
				</div>
				<div class="col-lg-6 right-abw3ls mt-lg-0 mt-sm-5 mt-4">
					<h4 class="font-italic border-bottom text-center font-weight-bold pb-3 mb-4">About our Packages</h4>
					<p>What makes our Institute stand out compared to others is the packages we offer to our students.We Offer monthly packages to our students extending for a duration of around 1 to 6 months normally, with intensive and friendly classes from Monday to Friday every week till the commencement of package.Every week a new session would be organised in regards with the opted package.Occasionally students are also given a opportunity to be a part of classes held by well-renowed Mural artist who have made their signature in this field. </p>
				<!--	<p class="mt-3">VarnaKerala is an institute on a mission to help such innumerable unrecognized artists; refine and sharpen their                                    skills to perfection. The institute seeks to provide extensive range of training in the least amount of time, with the use of the                                    most modern techniques and facilities. In the past 10 years, 500 of students have passed through these doors to excel in                                    varied streams of art and have made successful careers for themselves. The training at VarnaKerala not only provides you success as a                                     painter but also helps you establish your career in the fields of Fabric, Non-Fabric, Accecories and many more.</p>-->
				</div>
			</div>
		</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row inst-grids pt-md-4">
				<div class="col-md-3 col-6 blog-gd-w3ls">
					<img src="images/pic1.png" alt=" " class="img-fluid">
					<div class="date-w3">
						<h4>Group Works</h4>
				...
				<div class="col-md-3 col-6 blog-gd-w3ls">
					<img src="images/pic2.png" alt=" " class="img-fluid">
					<div class="date-w3">
						<h4>Creativity</h4>
						<!--<p class="para-w3-agile">Phasellus sed iaculis</p>
						<div class="agileinfo-social-grids">
				...
				<div class="col-md-3 col-6 blog-gd-w3ls  last mt-md-0 mt-sm-5 mt-4">
					<img src="images/pic3.jpg" alt=" " class="img-fluid">
					<div class="date-w3">
						<h4>Guidance</h4>
						<!--<p class="para-w3-agile">Phasellus sed iaculis</p>
						<div class="agileinfo-social-grids">
